...
import { Home, Search, Heart, User, LogOut, PlusSquare, LayoutDashboard } from 'lucide-react';
import './Navbar.css';
                        ...
                        <>
                            {user.role === 'Owner' ? (
                                <>
                                    ...
                                    <Link to="/add-property" className="nav-item"><PlusSquare size={20} /> Add Property</Link>
                                </>
                            ) : (
                                <>
